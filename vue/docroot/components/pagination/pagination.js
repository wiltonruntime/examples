    ...
    return {
        ...
        template: `
            <div class="pagination">
                <a class="pagination__button pagination__next" href="javascript:void(0)" v-on:click="nextPage"
                   v-if="hasNext()">
                    next
                </a>
                <div class="pagination__mid">
                    <ul class="pagination__list">
                        <li class="pagination__list-cell pagination__list-cell-first">
                            <a class="pagination__link" v-on:click="changePage(1)" href="javascript:void(0);"
                               v-bind:class="{ current: currentPage === page }" v-if="hasFirst()">1</a>
                        </li>
                        ...
                        <li class="pagination__list-cell" v-for="page in pages">
                            <a href="javascript:void(0);" class="pagination__link" v-on:click="changePage(page)"
                        ...
                        <li class="pagination__list-cell pagination__list-cell-last">
                            <a class="pagination__link" v-on:click="changePage(totalPages)" href="javascript:void(0);"
                               v-bind:class="{ current: currentPage === page }" v-if="hasLast()">{{ totalPages }}</a>
                        </li>
                    </ul>
                </div>
                <a class="pagination__button pagination__prev" href="javascript:void(0)" v-on:click="prevPage"
                   v-if="hasPrev()">
                    prev
                </a>
            </div>
